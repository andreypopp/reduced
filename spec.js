...
var all, asSeq, deepEqual, drop, dropWhile, equal, filter, fold, join, map, mapCat, ok, produced, reduced, resolve, scan, take, takeWhile, _ref, _ref1, _ref2;

_ref = require('assert'), deepEqual = _ref.deepEqual, equal = _ref.equal, ok = _ref.ok;

_ref1 = require('./index'), asSeq = _ref1.asSeq, map = _ref1.map, scan = _ref1.scan, fold = _ref1.fold, take = _ref1.take, drop = _ref1.drop, takeWhile = _ref1.takeWhile, dropWhile = _ref1.dropWhile, filter = _ref1.filter, join = _ref1.join, mapCat = _ref1.mapCat, reduced = _ref1.reduced, produced = _ref1.produced;
...
describe('combinators', function() {
  ...
  return it('provides mapCat', function(done) {
    var c1, c2, seq;
