...
var all, asSeq, deepEqual, drop, dropWhile, equal, filter, fold, join, lazy, map, mapCat, ok, produced, reduced, repeat, resolve, scan, series, take, takeWhile, zip, _ref, _ref1, _ref2;

_ref = require('assert'), deepEqual = _ref.deepEqual, equal = _ref.equal, ok = _ref.ok;

_ref1 = require('./index'), asSeq = _ref1.asSeq, lazy = _ref1.lazy, repeat = _ref1.repeat, map = _ref1.map, scan = _ref1.scan, fold = _ref1.fold, series = _ref1.series, take = _ref1.take, drop = _ref1.drop, takeWhile = _ref1.takeWhile, dropWhile = _ref1.dropWhile, filter = _ref1.filter, join = _ref1.join, mapCat = _ref1.mapCat, zip = _ref1.zip, reduced = _ref1.reduced, produced = _ref1.produced;
